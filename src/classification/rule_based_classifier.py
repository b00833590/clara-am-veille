...
_AUTO_EXCLUDE_PATTERN = re.compile(
    ...
    r"juridique|juriste|\blegal\b|compliance|conformit[ée]|\baml\b|\bkyc\b|"
    r"audit interne|contr[oô]le de gestion|contr[oô]leur (financier|des risques)|financial controller|"
    r"contr[oô]le financier|risk controller|"
